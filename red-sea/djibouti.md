...
region: Red Sea
sub_region: Seven Brothers
status: "Good to Very Good"
tier: 2
coral_rating: "Good-VG"
marine_life_rating: "Good"
best_season: "October-February"
peak_months: [Oct, Nov, Dec, Jan, Feb]
access: "Fly Djibouti City via Addis/Dubai"
liveaboard: false
liveaboard_season: ~
water_temp_range: "25-32C"
visibility_range: "5-30m"
experience_level: "Advanced to Expert (Seven Brothers); Beginner to Intermediate (Moucha/Maskali)"
...
### Seven Brothers Islands (Iles des Sept Freres)

Seven rocky volcanic islands in the Bab el-Mandeb strait between the Red Sea and the Gulf of Aden. The biogeographic position is exceptional: a Red Sea / Indian Ocean transition zone where species from both basins overlap, producing unusually high diversity for such a small area.

Dive topography: steep walls dropping into deep channels, current-scoured reef flats on leeward sides, boulder fields, and coral-encrusted slopes. The strait funnels massive tidal exchange between the Red Sea and Gulf of Aden, creating **very strong currents** — this is advanced diving. Drift dives along walls are the primary format. Currents are the main reason coral here has remained healthy: constant water movement and upwelling buffer thermal stress.

No widely published named dive sites — this is not a mapped-out destination. Operators explore opportunistically based on conditions. The islands themselves are uninhabited and barren above water; the interest is entirely underwater.

Hard coral coverage reportedly high on sheltered leeward slopes, with abundant table corals, massive Porites, and soft coral fans on deeper walls.
...
- **Whale sharks** are the headline draw (Nov-Feb, Gulf of Tadjoura). Multiple sharks per outing is common in peak season.
...
- **Visibility**: highly variable. Gulf of Tadjoura: 5-15m (plankton-rich, especially whale shark season). Seven Brothers: 15-30m on good days, but current-stirred sediment can reduce it. Do not expect Red Sea clarity.
- **Temperature**: 25-28C in winter (Nov-Feb), 29-32C in summer. The 31C recorded during the 2023 research mission caused no bleaching, suggesting thermal tolerance or current buffering.
- **Currents**: the Seven Brothers have genuinely dangerous currents — comparable to Komodo's strongest sites. Advanced certification and current experience essential. Gulf of Tadjoura sites are calmer.
- **Difficulty**: Seven Brothers = advanced to expert. Moucha/Maskali = beginner to intermediate.

## Season

- **Oct-Feb**: best overall window. Whale shark season (Nov-Feb), cooler water temperatures, calmer seas. This is peak.
- **Mar-May**: transitional, still diveable but warming rapidly. Whale sharks taper off.
- **Jun-Sep**: extreme heat (air temps 40-45C+), strong winds (Khamsin), and rough seas make the Seven Brothers largely inaccessible. Djibouti City shore sites may still operate. Essentially off-season.
- **Sweet spot**: November-January combines whale sharks, tolerable heat, and the best Seven Brothers access.

## Practical Info

- **Access**: Djibouti-Ambouli International Airport. Direct flights from Addis Ababa (1h), Dubai (3.5h via Air Arabia/flydubai), Paris (via Air France, seasonal). Ethiopian Airlines is typically the most practical connection. Djibouti City is the sole base.
...
- **Liveaboards**: **essentially nonexistent as a regular offering.** No established liveaboard circuit comparable to Red Sea or Maldives. Occasional expedition charters (sometimes originating from Yemen/Eritrea routes pre-conflict) may visit the Seven Brothers, but nothing scheduled or bookable in a normal sense. A dedicated yacht charter arranged through Djibouti City is the only realistic way to dive the Seven Brothers with multiple days of access.
