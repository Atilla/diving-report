...
region: Indian Ocean
sub_region: Mozambique
status: "MEGAFAUNA IN ALARMING DECLINE; coral mixed; best reefs inaccessible"
tier: 3
coral_rating: "Moderate (Bazaruto bleached)"
marine_life_rating: "Good but megafauna declining"
best_season: Oct-Nov best overall
peak_months: [Oct, Nov]
access: Fly Maputo + domestic
liveaboard: false
liveaboard_season: ~
water_temp_range: "19-29C"
visibility_range: "10-30m"
experience_level: Advanced recommended for Tofo and Ponta do Ouro
...
Megafauna destination, not a coral destination. Upwelling provides some thermal buffering for coral but data is sparse. Humpback whales (Jun-Nov) remain reliable.

#### Bazaruto Archipelago

The most important coral area in central Mozambique. African Parks management since 2017. Sharks on 34% of monitored dives, turtles/rays on ~50%. Last viable dugong population in the WIO (~325 individuals, Critically Endangered). Under bleaching stress 2024-2025.
...
- **Manta rays**: 88-99% decline in sightings at Tofo over two decades. Now "lucky chance encounters."
- **Whale sharks**: 87% decline in sightings, 89% decline in abundance over 15 years.
- **Sharks**: 19 species at Ponta do Ouro including bull sharks (Oct-Mar), tiger sharks, hammerheads.
- **Dugongs**: Last viable population in the WIO (~325 individuals) at Bazaruto.
- **Humpback whales**: Jun-Nov, remain reliable.

## Dive Conditions

| Region | Visibility | Temperature | Currents | Profiles |
|---|---|---|---|---|
| **Tofo/Inhambane** | 10–25m (best Oct–Mar) | 21–28C | Moderate to strong Agulhas-driven drift | 12–30m; ocean dives off granite reefs |
| **Bazaruto** | 15–30m (clearest in Mozambique) | 24–29C | Mild inside archipelago; surge on outer reefs | 8–25m; sheltered lagoons + deeper reef systems |
| **Ponta do Ouro** | 10–20m (upwelling reduces viz) | 19–25C (coolest region) | Strong Agulhas current; advanced drift | 15–35m; deep pinnacles |

The Agulhas Current is the dominant factor — pushes warm water south and drives plankton blooms that attract megafauna but reduce visibility seasonally.

## Season

- **Dry/cool (May–Oct)**: Best air comfort, cooler water (19–24C south, 25–27C north). Humpback whales Jul–Sep.
- **Wet/warm (Nov–Mar)**: Warmer water, plankton blooms, occasional reduced viz. Whale shark peak Oct–Mar.
- **Cyclone season**: Nov–Apr (peak Jan–Mar), primarily central/northern coast. Cyclones Freddy (2023) and Chido (2024) caused major reef damage.
- **Best overall window**: **Oct–Nov** — warm water, pre-cyclone calm, whale shark arrivals, tail-end whale season.
