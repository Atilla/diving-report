...
access: Fly Zanzibar/Dar es Salaam
liveaboard: false
liveaboard_season: ~
...
**Arguably the most underrated destination in the Indian Ocean.** Deep Pemba Channel (800m+) creates upwelling that may buffer thermal stress. Wall diving along dramatic drop-offs. Far less developed for tourism than Zanzibar.

- Misali Island (conservation area): coral cover 40-60%+ in protected areas. Strong currents bring pelagics — reef sharks, eagle rays, occasional mantas, large trevallies.
- Very few dive operators. Genuinely off-the-beaten-path.
