...
region: Indian Ocean
sub_region: Seychelles
status: "INNER ISLANDS MODERATE; OUTER ATOLLS WORLD-CLASS"
tier: 2
coral_rating: "Mod-Good (50-70% outer)"
marine_life_rating: "Excellent at outer atolls"
best_season: Mar-May, Oct-Nov
peak_months: [Mar, Apr, May, Oct, Nov]
access: Fly Mahe
liveaboard: true
liveaboard_season: Mar-May, Oct-Nov (inter-monsoon windows)
water_temp_range: "26-30C"
visibility_range: "15-30m"
experience_level: Intermediate to advanced for outer atolls
...
**INNER ISLANDS MODERATE; OUTER ATOLLS WORLD-CLASS**
...
### Inner islands (Mahe, Praslin, La Digue)
...
One of the world's largest raised coral atolls (34km x 14.5km). Outer reef walls with excellent coral cover, exceptional shark diversity (grey reef, whitetip, blacktip, nurse, occasional hammerheads), green turtles, mantas. Access extremely limited (SIF research station only, liveaboard permits tightly controlled). "The Galapagos of the Indian Ocean."
...
More accessible, excellent wall diving, Napoleon wrasse, grey reef sharks, turtles.

#### D'Arros / St. Joseph (Amirantes)

Save Our Seas Foundation research station. Manta cleaning stations. Shark nursery areas.

- Outer islands generally maintained **50-70%+ coral cover** through events that devastated inner reefs. Deeper water, stronger currents, and remoteness from human stressors are key factors.
...
- **Temperature:** 26–30C year-round. Minimal seasonal variation. 3mm or rashguard sufficient.
- **Visibility**: 15-30m depending on site and conditions.
- **Currents**: Variable; strong at outer atoll sites.
...
- **Turtles:** green and hawksbill year-round. Nesting Oct–Mar on outer island beaches.
- **SE monsoon (May–Sep):** stronger winds, rougher seas, reduced visibility. Outer atoll expeditions don't run. Inner island diving continues but conditions are less ideal.
- **NW monsoon (Dec–Feb):** milder than SE monsoon but still choppier than transition months. Some liveaboards run Amirantes circuits.
- **Cyclone risk:** low — Seychelles sits north of the main SW Indian Ocean cyclone belt, but rare storms can affect operations (Cyclone Freddy 2023 passed near).
