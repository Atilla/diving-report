...
Basaltic caves (80m cave, 80m tunnel). Orange frogfish, squid schools, nudibranchs. Premier macro/critter site.

#### Pain de Sucre

Maze of passages, overhangs, caves. Hawksbill turtles, jacks, lobsters.

#### Hai Siang wreck (54m)

Taiwanese lobster boat at depth — schools of snappers, stingrays, possible whale shark. Technical dive.

The underwater landscape is basaltic lava flows, canyons, caves, swim-throughs — fundamentally different from coral-dominated tropical diving.

**March 2026 eruption**: Piton de la Fournaise lava entered the Indian Ocean on March 16, 2026 — first ocean entry in 19 years. New lava delta extended the coastline by 190m. Will create fascinating new dive topography on the east coast in coming years. West coast dive sites entirely unaffected.

## Marine Life

- 885 reef fish species, 9 endemic (including Reunion Angelfish). **World-class macro**: nudibranchs, Spanish dancers, frogfish, mantis shrimp, porcelain crabs.
- **Humpback whales (Jun-Oct)**: the single most compelling marine attraction. Snorkeling excursions (tank diving with whales not permitted). Groups of max 9 people plus instructor. Peak mid-Aug to mid-Sep. **Transforms Reunion from "decent diving" to "bucket-list experience."**
- Spinner dolphins year-round. Turtles (hawksbill and green) increasingly common.
- Large pelagics uncommon due to overfishing.

## Dive Conditions

- **Visibility**: 15-30m.
- **Temperature**: 22-28C. Coolest Jul-Aug, warmest Feb-Mar.
- **Currents**: Variable; strong at Le Tombant de la Pointe au Sel.

## Season

- Best overall window: **Jun-Nov** (dry season + whale season + good diving conditions). Avoid Jan-Mar (cyclone season).
- **Humpback whales**: Jun-Oct. Peak mid-Aug to mid-Sep.
- **Macro**: Year-round.
