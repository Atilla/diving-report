...
status: "Wrecks deteriorating but still world's undisputed #1 wreck diving destination"
tier: 3
coral_rating: "N/A (wreck destination)"
marine_life_rating: "Good (coral growth on wrecks)"
best_season: "Year-round (best December-April for visibility)"
peak_months: [Dec, Jan, Feb, Mar, Apr]
access: "Fly Weno via Guam (island-hopper)"
liveaboard: true
liveaboard_season: "Seasonal (Truk Master)"
water_temp_range: "28-30C"
visibility_range: "10-20m"
experience_level: "Advanced Open Water minimum; Technical for deep wrecks and penetration"
...
- **Vehicles**: Ha-Go tanks (San Francisco Maru holds, Nippo Maru deck), Ford trucks and bulldozers (Hoki Maru), at least one motorcycle
- **Weaponry**: Torpedoes (Heian Maru — rows of them), 46cm battleship shells (Yamagiri Maru), naval mines (San Francisco Maru), deck guns and AA weapons on multiple wrecks, aerial bombs (Sankisan Maru)
- **Personal items**: Sake and beer bottles (enormous quantities, especially Rio de Janeiro Maru), Japanese porcelain dishes and cups in galleys, gas masks, shoes and boots, medicine bottles and surgical instruments (Shinkoku Maru operating theatre)
- **Ship equipment**: Engine order telegraphs (Nippo Maru, Kensho Maru), binnacles, anchor gear
- **Looting**: Significant from 1960s–80s before protections were strengthened. Smaller artifacts most affected. Major items (tanks, trucks, torpedoes) remain because they're too large to remove. FSM law now prohibits artifact removal. Some pilferage continues.

## Dive Conditions

- **Visibility**: 10–20m typical, with occasional better days reaching 25–30m. Can drop to 5–8m during plankton blooms or after rain. Inside wrecks: 3–10m before silt disturbance, potentially zero after careless finning. **Not the Maldives** — divers expecting tropical clarity will be surprised. The enclosed, nutrient-rich lagoon supports the spectacular coral growth on the wrecks but reduces visibility.
- **Best viz**: Dry season (Dec–Apr), early morning dives, slack tide, outer lagoon sites.
- **Temperature**: 28–30C year-round. 3mm or rashguard.
- **Currents**: Generally mild within the lagoon. Occasional current at certain sites and tidal states.
- **Photography**: Wide-angle essential (fisheye/ultra-wide). Powerful strobes critical — color loss is significant in the green water. Backscatter management (arms wide, angled outward) more important here than in clear-water destinations. The interiors are the money shots — cargo holds with tanks, torpedoes, shells. Requires excellent buoyancy to avoid silt-outs.
...
- **Recompression chamber**: A chamber exists on Chuuk but its operational readiness has been inconsistent. **Conservative dive planning is essential** — this is not a destination where you want to push limits. Evacuation insurance strongly recommended (serious cases may require Guam evacuation).
- **Medical facilities**: Chuuk State Hospital is extremely basic. Serious medical issues require evacuation to Guam or Hawaii.
- **Experience level**: Advanced Open Water minimum. Wreck penetration requires appropriate certification (TDI Advanced Wreck or equivalent) and significant experience. Nitrox highly recommended for multiple deep dives/day. Technical diving (trimix) for San Francisco Maru and deep portions of other wrecks — but technical gas fills may need to be specially arranged in advance.
- **Munitions safety**: Live ordnance is present on multiple wrecks. Do not touch anything.
