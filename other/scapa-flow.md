...
region: Other
sub_region: Europe / Orkney Islands, Scotland
status: "World-class — the only place on Earth to dive WWI dreadnought battleships; deteriorating"
tier: 3
coral_rating: "N/A (cold water)"
marine_life_rating: "Good (cold-water)"
best_season: "June-October (best July-September)"
peak_months: [Jul, Aug, Sep]
access: "Fly Kirkwall or ferry from Scottish mainland"
liveaboard: true
liveaboard_season: "Jun-Oct"
water_temp_range: "6-13C"
visibility_range: "5-15m"
experience_level: "Advanced OW + Deep Diver minimum (capital ships); Technical (penetration)"
...
- On June 21, 1919, Rear Admiral Ludwig von Reuter ordered the scuttling of the interned German High Seas Fleet — the greatest act of maritime self-destruction in history. 52 of 74 warships sank. Most were salvaged in the 1920s–40s in one of the century's greatest engineering feats.
- **Seven major German warships remain unsalvaged**: 3 Konig-class battleships (175m, ~26,000 tons each) and 4 light cruisers. All are **Scheduled Ancient Monuments** — the highest heritage protection in Scotland.
- **The wrecks are deteriorating.** Over 100 years old, hull plating is collapsing, structural instability increasing. Trip reports from 2023–2025 note accelerating decline on SMS Konig. Within 20–50 years, these may collapse from recognizable warships to debris fields. **This is a "dive sooner rather than later" destination.**
- Cold, tide-dependent diving in a semi-enclosed anchorage surrounded by wind-scoured islands at 59 degrees N. Drysuit essential. Not tropical glamour — this is austere, dramatic, historically heavy diving.
- Liveaboard options exist (MV Halton, MV Huskyan) — a key advantage since diving is tide-dependent and slack water may fall at any hour.
...
**Surprisingly rich cold-water community**: Large ballan wrasse, pollock, conger eels, lobsters, edible crabs, velvet swimming crabs. Dead men's fingers soft corals, plumose anemones, dahlia anemones on wreck surfaces. Nudibranchs, sea urchins, starfish. Lion's mane jellyfish can be a nuisance late summer.

The blockships are particularly prolific — anemone gardens, crustacean colonies, kelp forests.

## Dive Conditions

- **Visibility**: 5–15m typical. Occasionally 20m+ (spring before plankton bloom, or autumn). Can drop to 2–3m during plankton blooms (Jun–Jul). Deeper wrecks often better viz below the thermocline.
- **Temperature**: Summer 10–13C surface / 8–10C at depth. Winter 6–8C. Thermocline in summer.
- **Currents**: **The critical safety factor.** Enormous tidal exchanges through the sounds (can exceed 6 knots). All wreck diving planned around slack water — typically 1–2 hour diveable windows. Operators are expert at calculating slack times. Heavy shotlines placed on wrecks; descend/ascend on the line. Spring tides = shorter windows; neap tides preferred.
- **Exposure**: Drysuit essential. Thick undersuit, hood, dry gloves recommended.
- **Experience level**: Blockships — Advanced OW with wreck/cold water experience. Light cruisers — Advanced OW + Deep Diver minimum. Battleships — Advanced certifications strongly recommended; many operators require AOW + Deep Diver + 50 logged dives minimum. Penetration — technical certification and significant experience.

## Season

- **Main season**: June–October. **Peak: July–September** — longest daylight (barely gets dark at midsummer at 59 degrees N), warmest water, most operator availability.
- **September–October**: Often best visibility (plankton dying off, water still relatively warm).
- **June**: Can have plankton bloom reducing viz.
- **Winter**: Rare — short days, storms, very cold, limited operators.
